...
import com.ant.yun.beans.TypeConverter;
import com.ant.yun.beans.factory.*;
import com.ant.yun.beans.factory.config.*;
import com.ant.yun.core.MethodParameter;
...
public abstract class AbstractAutowireCapableBeanFactory extends AbstractBeanFactory implements AutowireCapableBeanFactory {
    ...
    protected Class<?> getTypeForFactoryBean(String beanName, RootBeanDefinition mbd) {
        if (mbd.getInstanceSupplier() != null) {
            ...
            Class result;
            if (targetType != null) {
                result = targetType.as(FactoryBean.class).getGeneric(new int[0]).resolve();
                if (result != null) {
                    return result;
                }
            }
