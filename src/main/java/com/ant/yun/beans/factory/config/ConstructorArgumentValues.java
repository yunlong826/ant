...
public class ConstructorArgumentValues {
    ...
    public ConstructorArgumentValues.ValueHolder getIndexedArgumentValue(int index, @Nullable Class<?> requiredType, @Nullable String requiredName) {
        ...
        return valueHolder == null || valueHolder.getType() != null && (requiredType == null || !ClassUtils.matchesTypeName(requiredType, valueHolder.getType())) || valueHolder.getName() != null && (requiredName == null || !requiredName.isEmpty() && !requiredName.equals(valueHolder.getName())) ? null : valueHolder;
    }
    ...
    public ConstructorArgumentValues.ValueHolder getGenericArgumentValue(@Nullable Class<?> requiredType, @Nullable String requiredName, @Nullable Set<ConstructorArgumentValues.ValueHolder> usedValueHolders) {
        ...
        do {
            while(true) {
                ...
                } while(valueHolder.getName() != null && (requiredName == null || !requiredName.isEmpty() && !requiredName.equals(valueHolder.getName())));
